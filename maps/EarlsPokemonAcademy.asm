EarlsPokemonAcademy_MapScriptHeader:
	...
	object_event  5,  9, SPRITE_LASS, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, EarlsPokemonAcademyGuardGirlScript, EVENT_VIOLET_OUTSKIRTS_BLOCKED
