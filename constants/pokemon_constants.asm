...
DEF NUM_VARIANT_FORMS EQU const_value - FIRST_VARIANT_FORM_MON ; 36

; these constants include EGG and a dummy entry as species
DEF NUM_UNIQUE_POKEMON EQU const_value - 1 ; 193
DEF NUM_EXT_POKEMON EQU NUM_UNIQUE_POKEMON - NUM_COSMETIC_FORMS ; 15a
