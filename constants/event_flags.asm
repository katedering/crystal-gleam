...
; Johto story events
	...
	const EVENT_GOT_POWER_HERB_FROM_KIMI
...
; CooltrainerF
	...
	const EVENT_BEAT_COOLTRAINERF_KIMI
...
; Custom Events
	const EVENT_LISTENED_TO_KATE
	const EVENT_INITIAL_BATTLE_KATE
	const EVENT_BEAT_KATE
	const EVENT_LISTENED_TO_ASH
	const EVENT_INITIAL_BATTLE_ASH
	const EVENT_BEAT_ASH
	const EVENT_LISTENED_TO_TRIP
	const EVENT_INITIAL_BATTLE_TRIP
	const EVENT_BEAT_TRIP
	const EVENT_LISTENED_TO_FEDMAE
	const EVENT_INITIAL_BATTLE_FEDMAE
	const EVENT_BEAT_FEDMAE
	const EVENT_INDIGO_PLATEAU_GUIDE_GIRL_INTRO
	const EVENT_CUTE_INTRO
	const EVENT_GALARIAN_CORSOLA_INTRO
	const EVENT_GOT_GALARIAN_CORSOLA
	const EVENT_VIOLET_OUTSKIRTS_BLOCKED
	const EVENT_GOT_RARE_CANDY_IN_ACADEMY
	const EVENT_VIOLET_OUTSKIRTS_ULTRA_BALL
	const EVENT_BOUGHT_HISUIAN_QWILFISH
	const EVENT_LISTENED_TO_ROCKET_IN_CLIFF_GATE
	const EVENT_BEAT_ROCKET_IN_CLIFF_GATE
	const EVENT_INITIAL_BATTLE_ROCKET
	const EVENT_LISTENED_TO_UNKNOWN
	const EVENT_BEAT_UNKNOWN
	const EVENT_GOT_HISUIAN_TYPHLOSION
	const EVENT_GARTICUNO_GONE
	const EVENT_BATTLED_GARTICUNO
	const EVENT_GZAPDOS_GONE
	const EVENT_BATTLED_GZAPDOS
	const EVENT_GMOLTRES_GONE
	const EVENT_BATTLED_GMOLTRES
	const EVENT_REDS_PIKA_INTRO
	const EVENT_GOT_REDS_PIKACHU
	const EVENT_BEAT_SUPER_NERD_HERB
	const EVENT_VIOLET_HAUNTED_HOUSE_GHOST
	const EVENT_LISTENED_TO_LALA_INTRO
	const EVENT_GOT_EEVEE_FROM_LALA
	const EVENT_GOT_EON_STONE_FROM_ELM
