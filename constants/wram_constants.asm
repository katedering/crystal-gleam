...
; wDailyFlags4::
	...
	const DAILYFLAGS4_DAILY_CLIFF_GATE_RESET_F        ; 6
	const DAILYFLAGS4_DAILY_ELITE_FAUX_RESET_F        ; 7
...
; wPlayerCaught2::
	...
	const PLAYER_CAUGHT_GARTICUNO_F ; 4
	const PLAYER_CAUGHT_GZAPDOS_F   ; 5
	const PLAYER_CAUGHT_GMOLTRES_F  ; 6
	const PLAYER_CAUGHT_GHOST_F     ; 7
