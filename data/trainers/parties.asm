...
TwinsGroup:
	...
	def_trainer AMYANDMAY1, "Amy & May"
	tr_mon 13, SPINARAK
	tr_mon 13, LEDYBA
	end_trainer

	def_trainer AMYANDMAY2, "Amy & May"
	tr_mon 13, LEDYBA
	tr_mon 13, SPINARAK
	end_trainer
...
KatyGroup:
	...
	def_trainer 1, "Katy"
	tr_mon LEVEL_FROM_BADGES + 18, ARIADOS
	tr_mon LEVEL_FROM_BADGES + 19, BUTTERFREE
	tr_mon LEVEL_FROM_BADGES + 20, SHUCKLE
	tr_mon LEVEL_FROM_BADGES + 20, KLEAVOR
	tr_mon LEVEL_FROM_BADGES + 18, HERACROSS
	tr_mon LEVEL_FROM_BADGES + 21, URSARING
	end_trainer

	def_trainer 2, "Katy"
	tr_mon LEVEL_FROM_BADGES + 8, ARIADOS
	tr_mon LEVEL_FROM_BADGES + 7, BUTTERFREE
	tr_mon LEVEL_FROM_BADGES + 8, SHUCKLE
	tr_mon LEVEL_FROM_BADGES + 8, KLEAVOR
	tr_mon LEVEL_FROM_BADGES + 9, HERACROSS
	tr_mon LEVEL_FROM_BADGES + 11, URSALUNA
	end_trainer
