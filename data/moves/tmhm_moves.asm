...
; entries correspond to *_TMNUM constants (see constants/item_constants.asm)
	...
	db METRONOME	; MT19 (Goldenrod Band House)
	db PAY_DAY      ; MT20 (Goldenrod Game Corner)
	db ROLLOUT      ; MT21 (Route 46)
	db SEED_BOMB    ; MT21 (Yellow Forest)
	db SEISMIC_TOSS ; MT23 (Pewter City)
	db SKILL_SWAP   ; MT24 (Route 27)
	db SLEEP_TALK   ; MT25 (Route 31)
	db SUCKER_PUNCH ; MT26 (Scary Cave)
	db SWAGGER      ; MT27 (Celadon City)
	db THUNDERPUNCH ; MT28 (Goldenrod City)
	db TRICK        ; MT29 (Battle Tower)
	db TRICK_ROOM   ; MT30 (Route 16 South Gate)
