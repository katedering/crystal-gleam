...
SongInfo:
	...
	song_info "RBY Title Screen", ORIGIN_RB, COMPOSER_GO_ICHINOSE, COMPOSER_FROGGESTSPIRIT
	song_info "RBY Wild Battle", ORIGIN_RB, COMPOSER_GO_ICHINOSE, COMPOSER_FROGGESTSPIRIT
	song_info "RBY Trainer Battle", ORIGIN_RB, COMPOSER_GO_ICHINOSE, COMPOSER_FROGGESTSPIRIT
	song_info "RBY Gym Battle", ORIGIN_RB, COMPOSER_GO_ICHINOSE, COMPOSER_FROGGESTSPIRIT
	song_info "RBY Final Battle", ORIGIN_RB, COMPOSER_GO_ICHINOSE, COMPOSER_FROGGESTSPIRIT
	song_info "RBY Rival Encounter", ORIGIN_RB, COMPOSER_GO_ICHINOSE, COMPOSER_FROGGESTSPIRIT
	song_info "RBY Rival Farewell", ORIGIN_RB, COMPOSER_GO_ICHINOSE, COMPOSER_FROGGESTSPIRIT
	song_info "FRLG Wild Battle", ORIGIN_FRLG, COMPOSER_JUNICHI_MASUDA_GO_ICHINOSE, COMPOSER_TRITEHEXAGON
	song_info "FRLG Gym Leader", ORIGIN_FRLG, COMPOSER_JUNICHI_MASUDA_GO_ICHINOSE, COMPOSER_TRITEHEXAGON
	song_info "FRLG Elite Four", ORIGIN_FRLG, COMPOSER_JUNICHI_MASUDA_GO_ICHINOSE, COMPOSER_TRITEHEXAGON
	song_info "FRLG Sevii Islands", ORIGIN_FRLG, COMPOSER_JUNICHI_MASUDA_GO_ICHINOSE, COMPOSER_TRITEHEXAGON
	song_info "DPPT Wild Battle", ORIGIN_DPPT, COMPOSER_JUNICHI_MASUDA_GO_ICHINOSE, COMPOSER_TRITEHEXAGON
	song_info "Vs.Cynthia (2)", ORIGIN_DPPT, COMPOSER_JUNICHI_MASUDA_GO_ICHINOSE, COMPOSER_TRITEHEXAGON
	song_info "Vs.Frontier Brain   Platinum", ORIGIN_DPPT, COMPOSER_JUNICHI_MASUDA_GO_ICHINOSE, COMPOSER_TRITEHEXAGON
	song_info "Vs.Giovanni", ORIGIN_SM, COMPOSER_JUNICHI_MASUDA_GO_ICHINOSE, COMPOSER_TRITEHEXAGON
	song_info "HGSS Ice Path", ORIGIN_HGSS, COMPOSER_JUNICHI_MASUDA_GO_ICHINOSE, COMPOSER_TRITEHEXAGON
